...
export const isPC = () => {
        ...
        for (let index = 0; index < Agents.length; index++) {
            if (userAgentInfo.indexOf(Agents[index].toLocaleLowerCase()) > 0) {
                isPC = false
                break;
            }
        }
    return isPC && window.innerWidth > 750
    }
...
export const isAndroid = (() => {
    let isAndroid = false
    let AndroidAgents = ["Android", "XiaoMi/MiuiBrowser"]
    for (let index = 0; index < AndroidAgents.length; index++) {
        if (userAgentInfo.indexOf(AndroidAgents[index].toLocaleLowerCase()) > 0) {
            isAndroid = true
            break;
...
export const isIPhone = (() => {
    let isIPhone = false
    let IPhoneAgents = ["iPhone", "iPhone"]
    for (let index = 0; index < IPhoneAgents.length; index++) {
        if (userAgentInfo.indexOf(IPhoneAgents[index].toLocaleLowerCase()) > 0) {
            isIPhone = true
            break;
